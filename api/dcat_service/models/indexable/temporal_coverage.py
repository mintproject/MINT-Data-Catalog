...
class TemporalCoverage:
    ...
    def to_json(self):
        start_time_str = self.start_time.strftime("%Y-%m-%dT%H:%M:%S") if self.start_time else None
        end_time_str = self.end_time.strftime("%Y-%m-%dT%H:%M:%S") if self.end_time else None
